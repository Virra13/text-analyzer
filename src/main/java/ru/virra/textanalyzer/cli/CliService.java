 ...
 * параметров, количество значений, формат путей и числовых значений, а также устанавливает значения
 * по умолчанию для необязательных параметров.</p>
 */
@Slf4j
@Component
public class CliService {
     ...
     *  <p>Обязательные параметры проверяются на наличие и корректность.
     *  Для параметров {@code threads} и {@code mode} используются значения
     *  по умолчанию, если они не указаны.</p>
     *
