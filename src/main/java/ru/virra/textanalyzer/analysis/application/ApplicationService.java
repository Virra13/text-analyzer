...
import ru.virra.textanalyzer.analysis.model.*;
 ...
 *
 * <p>Сервис сканирует указанную директорию, загружает стоп-слова,
 * выбирает стратегию обработки и формирует итоговый результат анализа.</p>
 */
@Slf4j
@Service
...
public class ApplicationService {
    ...
    /**
     * Выполняет анализ текстовых файлов согласно указанной конфигурации.
     *
     * <p>Метод сканирует директорию, загружает список стоп-слов,
     * выбирает стратегию обработки, выполняет анализ файлов,
     * формирует топ наиболее частых слов и список ошибок обработки.</p>
     *
     * @param config конфигурация анализа
     * @return итоговый результат анализа
     */
